...
(function($) {
    ...
    $.fn.Tabledit = function(options) {
            ...
            columns: {
                ...
                toolbar: function() {
                    if (settings.editButton || settings.deleteButton) {
                        ...
                        var toolbar_content = '<td class="toolbartabledit" style="white-space: nowrap; width: 1%;">' + toolbar + '</td>'

                        $table.find('tbody>tr:not(.tabledit-ok)').append(toolbar_content).addClass('tabledit-ok');
                    }
                }
            }
        };
        ...
        function ajax(action)
        {
            ...
            var jqXHR = result.done(function (jqXHR, textStatus) {
